...
const Authentication = () => {
  ...
  return (
    <Wrapper>
      ...
      {tokenData && isLoading && (
        <iframe title={'callApp'} width={'0px'} height={'0px'} src={`blox-live://token_id=${tokenData.id_token}&access_token=${tokenData.access_token}&refresh_token=${tokenData.refresh_token}`} />
      )}
    </Wrapper>
  );
}
