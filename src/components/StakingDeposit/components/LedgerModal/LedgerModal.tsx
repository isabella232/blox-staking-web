...
import ledgerLogo from './ledger-logotype.svg';
...
const LedgerModal = ({onClose, onClick}: Props) => {
  return (
    <ModalTemplate image={image} imageWidth={'200px'} padding={'32px 32px 32px 72px'}
      ...
      <Description>
        Securely execute Blox Staking deposit with MetaMask's Ledger integration.
      </Description>
      <ButtonWrapper>
